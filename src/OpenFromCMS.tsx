        ...
        <main className="framer-hide-scrollbar setup">
            <div className="intro">
                ...
                <div className="content">
                    ...
                    <p>
                        Restaurant Menu Import manages a CMS Collection. Open the <strong>CMS</strong>, add a new
                        Collection, and choose <strong>Restaurant Menu Import</strong> to manage it — then paste
                        your menu link.
                    </p>
                </div>
            </div>
